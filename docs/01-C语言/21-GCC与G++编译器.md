...
- [GCC/G++编译器深度使用指南](../05-开发环境与IDE/07-GCC编译器基础.md) — 编译参数完全指南、Sanitizer使用、常用技巧
- [编译器隐藏工具与鲜为人知的能力](../05-开发环境与IDE/10-二进制分析工具.md) — addr2line/ar/nm/objdump/readelf/strip等工具
