...
- [CMake与构建系统实战配置](../05-开发环境与IDE/03-CMake基础入门.md) — CMakeLists.txt完全写法、外部库4种配置方式
- [VS Code开发环境完全配置指南](../05-开发环境与IDE/00-VSCode核心配置.md) — VS Code + CMake Tools完整工作流
- [CLion开发环境配置](../05-开发环境与IDE/06-CLion开发环境配置.md) — CLion + CMake配合使用
- [Visual Studio开发环境配置指南](../05-开发环境与IDE/05-VisualStudio开发环境配置.md) — VS打开CMake项目
