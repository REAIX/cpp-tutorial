...
>
> **🔗 相关阅读**：
> - [什么是强制拷贝消除与RVO局限](35-什么是强制拷贝消除与RVO局限.md) — 聚焦 C++17 prvalue 语义变革带来的强制拷贝消除保证，以及 RVO 不能覆盖的场景
> - [什么是返回值优化失败的情况](37-什么是返回值优化失败的情况.md) — 聚焦 8 种 RVO 失败的具体场景、编译器差异对比及检查方法
...
- [什么是强制拷贝消除与RVO局限](./35-什么是强制拷贝消除与RVO局限.md)
- [什么是返回值优化失败的情况](./37-什么是返回值优化失败的情况.md)
