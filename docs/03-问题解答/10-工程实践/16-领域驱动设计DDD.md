...
- [框架引擎中间件与架构概念指南](../10-工程实践/16-框架引擎中间件与架构.md) — 框架/引擎/中间件/前后端/10种架构模式
- [编程范式实战指南](14-编程范式概览与过程式编程.md) — OOP范式与DDD充血模型的关系
- [设计原则SOLID](../04-工程实践/02-设计原则SOLID.md) — DDD遵循SOLID原则
- [设计模式](../04-工程实践/03-设计模式.md) — DDD中常用的工厂/策略/观察者模式
- [项目理解分析与工程化编码指南](../10-工程实践/13-项目理解分析与工程化编码.md) — 创建项目5步法、工程化重构
- [编程工程师与成长之道](../00-导学/01-编程工程师与成长之道.md) — 开发本质、技术四层面

***

### 相关阅读

- [框架引擎中间件与架构](./16-框架引擎中间件与架构.md)
- [依赖注入与控制反转](./19-依赖注入与控制反转.md)
