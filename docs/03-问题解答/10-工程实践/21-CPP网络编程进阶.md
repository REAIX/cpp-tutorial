# C++网络编程进阶
> 📖 相关章节：[网络编程](../../02-CPP/31-网络编程.md)、[网络编程基础](../../01-C语言/24-网络编程基础.md)
...
- [网络编程](../../02-CPP/31-网络编程.md) — Socket基础与TCP/UDP编程
- [网络编程基础](../../01-C语言/24-网络编程基础.md) — C语言Socket编程
- [框架引擎中间件与架构概念指南](15-框架引擎中间件与架构.md) — 框架/引擎/中间件/架构全景
- [序列化与反序列化](19-序列化与反序列化.md) — JSON/Protobuf/MessagePack序列化
- [序列化与日志](../../02-CPP/32-序列化与日志.md) — C++序列化库与日志系统

***

### 相关阅读

- [什么是I-O多路复用](../06-并发编程/31-什么是I-O多路复用.md)
